...
type AuthServiceRegistry struct {
	...
	CredentialsAuthnServiceExternal credentials.CredentialsAuthnServiceExternalInterface
...
func Initialize(
	...
	authServiceRegistry := createAuthServiceRegistry(idpSvc, jwtSvc, userSvc, otpSvc, externalSvc)
...
func createAuthServiceRegistry(
	...
	return &AuthServiceRegistry{
		...
		CredentialsAuthnServiceExternal: credentials.InitializeExternal(externalSvc),
