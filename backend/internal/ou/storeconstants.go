...
var (
	...
	queryGetRootOrganizationUnitListCount = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-01",
		Query: `SELECT COUNT(*) as total FROM ORGANIZATION_UNIT WHERE PARENT_ID IS NULL AND SERVER_ID = $1`,
	}
	...
	queryGetRootOrganizationUnitList = dbmodel.DBQuery{
		...
		Query: `SELECT OU_ID, HANDLE, NAME, DESCRIPTION, PARENT_ID FROM ORGANIZATION_UNIT ` +
			`WHERE PARENT_ID IS NULL AND SERVER_ID = $3 ORDER BY NAME LIMIT $1 OFFSET $2`,
	}

	// queryCreateOrganizationUnit is the query to create a new organization unit.
	queryCreateOrganizationUnit = dbmodel.DBQuery{
		ID: "OUQ-OU_MGT-03",
		Query: `INSERT INTO ORGANIZATION_UNIT (OU_ID, PARENT_ID, HANDLE, NAME, DESCRIPTION, SERVER_ID) ` +
			`VALUES ($1, $2, $3, $4, $5, $6)`,
	}
	...
	queryGetRootOrganizationUnitByHandle = dbmodel.DBQuery{
		ID: "OUQ-OU_MGT-05",
		Query: `SELECT OU_ID, PARENT_ID, HANDLE, NAME, DESCRIPTION FROM ORGANIZATION_UNIT ` +
			`WHERE HANDLE = $1 AND PARENT_ID IS NULL AND SERVER_ID = $2`,
	}
	...
	queryGetOrganizationUnitByHandle = dbmodel.DBQuery{
		ID: "OUQ-OU_MGT-06",
		Query: `SELECT OU_ID, PARENT_ID, HANDLE, NAME, DESCRIPTION FROM ORGANIZATION_UNIT ` +
			`WHERE HANDLE = $1 AND PARENT_ID = $2 AND SERVER_ID = $3`,
	}
	...
	queryCheckOrganizationUnitExists = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-07",
		Query: `SELECT COUNT(*) as count FROM ORGANIZATION_UNIT WHERE OU_ID = $1 AND SERVER_ID = $2`,
	}
	...
	queryGetOrganizationUnitChildrenCount = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-10",
		Query: `SELECT COUNT(*) as total FROM ORGANIZATION_UNIT WHERE PARENT_ID = $1 AND SERVER_ID = $2`,
	}
	...
	queryGetOrganizationUnitChildrenList = dbmodel.DBQuery{
		ID: "OUQ-OU_MGT-11",
		Query: `SELECT OU_ID, HANDLE, NAME, DESCRIPTION FROM ORGANIZATION_UNIT WHERE PARENT_ID = $1 AND SERVER_ID = $4 ` +
	...
	queryGetOrganizationUnitUsersCount = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-12",
		Query: `SELECT COUNT(*) as total FROM "USER" WHERE OU_ID = $1 AND SERVER_ID = $2`,
	}
	...
	queryGetOrganizationUnitUsersList = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-13",
		Query: `SELECT USER_ID FROM "USER" WHERE OU_ID = $1 AND SERVER_ID = $4 ORDER BY USER_ID LIMIT $2 OFFSET $3`,
	}
	...
	queryGetOrganizationUnitGroupsCount = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-14",
		Query: `SELECT COUNT(*) as total FROM "GROUP" WHERE OU_ID = $1 AND SERVER_ID = $2`,
	}
	...
	queryGetOrganizationUnitGroupsList = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-15",
		Query: `SELECT GROUP_ID, NAME FROM "GROUP" WHERE OU_ID = $1 AND SERVER_ID = $4 ORDER BY NAME LIMIT $2 OFFSET $3`,
	}
	...
	queryCheckOrganizationUnitNameConflict = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-16",
		Query: `SELECT COUNT(*) as count FROM ORGANIZATION_UNIT WHERE NAME = $1 AND PARENT_ID = $2 AND SERVER_ID = $3`,
	}
	...
	queryCheckOrganizationUnitNameConflictRoot = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-17",
		Query: `SELECT COUNT(*) as count FROM ORGANIZATION_UNIT WHERE NAME = $1 AND PARENT_ID IS NULL AND SERVER_ID = $2`,
	}
	...
	queryCheckOrganizationUnitHandleConflict = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-18",
		Query: `SELECT COUNT(*) as count FROM ORGANIZATION_UNIT WHERE HANDLE = $1 AND PARENT_ID = $2 AND SERVER_ID = $3`,
	}
	...
	queryCheckOrganizationUnitHandleConflictRoot = dbmodel.DBQuery{
		ID:    "OUQ-OU_MGT-19",
		Query: `SELECT COUNT(*) as count FROM ORGANIZATION_UNIT WHERE HANDLE = $1 AND PARENT_ID IS NULL AND SERVER_ID = $2`,
	}
	...
	queryCheckOrganizationUnitHasUsersOrGroups = dbmodel.DBQuery{
		ID: "OUQ-OU_MGT-20",
		Query: `SELECT 
					(SELECT COUNT(*) FROM ORGANIZATION_UNIT WHERE PARENT_ID = $1 AND SERVER_ID = $2) +
					(SELECT COUNT(*) FROM "USER" WHERE OU_ID = $1 AND SERVER_ID = $2) + 
					(SELECT COUNT(*) FROM "GROUP" WHERE OU_ID = $1 AND SERVER_ID = $2) as count`,
	}
)
