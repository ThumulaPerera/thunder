...
func (s *IDPStoreTestSuite) TestNewIDPStore() {
	store := newIDPStore(testServerID)
	s.NotNil(store)
...
func (s *IDPStoreTestSuite) TestCreateIdentityProvider_Success() {
	...
	s.mockDBClient.On("Execute", queryCreateIdentityProvider, idp.ID, idp.Name,
		idp.Description, idp.Type, `[{"name":"client_id","value":"test-client","is_secret":false}]`, testServerID).
		Return(int64(1), nil)
...
func (s *IDPStoreTestSuite) TestCreateIdentityProvider_NoProperties() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Execute", queryCreateIdentityProvider, idp.ID, idp.Name,
		idp.Description, idp.Type, "", testServerID).Return(int64(1), nil)
...
func (s *IDPStoreTestSuite) TestCreateIdentityProvider_ExecuteError() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Execute", queryCreateIdentityProvider, idp.ID, idp.Name,
		idp.Description, idp.Type, "", testServerID).Return(int64(0), errors.New("execute error"))
...
func (s *IDPStoreTestSuite) TestGetIdentityProviderList_Success() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderList, testServerID).Return(results, nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProviderList_EmptyList() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderList, testServerID).Return([]map[string]interface{}{}, nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProviderList_QueryError() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderList, testServerID).Return(nil, errors.New("query error"))
...
func (s *IDPStoreTestSuite) TestGetIdentityProvider_Success() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByID, "idp-123", testServerID).Return(results, nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProvider_NotFound() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByID, "non-existent", testServerID).
...
func (s *IDPStoreTestSuite) TestGetIdentityProvider_MultipleResults() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByID, "duplicate", testServerID).Return(results, nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProviderByName_Success() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByName, "Test IDP", testServerID).Return(results, nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProviderByName_NotFound() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByName, "Non-existent", testServerID).
		Return([]map[string]interface{}{}, nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProviderByName_QueryError() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByName, "Test", testServerID).
...
func (s *IDPStoreTestSuite) TestUpdateIdentityProvider_WithProperties() {
	...
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Execute", queryUpdateIdentityProviderByID, idp.ID, idp.Name,
		idp.Description, idp.Type, `[{"name":"client_id","value":"test","is_secret":false}]`, testServerID).
		Return(int64(1), nil)
...
func (s *IDPStoreTestSuite) TestDeleteIdentityProvider_Success() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Execute", queryDeleteIdentityProviderByID, "idp-123", testServerID).
		Return(int64(1), nil)
...
func (s *IDPStoreTestSuite) TestDeleteIdentityProvider_NotFound() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Execute", queryDeleteIdentityProviderByID, "non-existent", testServerID).
		Return(int64(0), nil)
...
func (s *IDPStoreTestSuite) TestGetIdentityProvider_QueryError() {
	s.mockDBProvider.On("GetConfigDBClient").Return(s.mockDBClient, nil)
	s.mockDBClient.On("Query", queryGetIdentityProviderByID, "idp-123", testServerID).
		Return(nil, errors.New("query error"))
