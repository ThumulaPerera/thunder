...
func (suite *RoleStoreTestSuite) TestGetRoleListCount_Success() {
	...
	suite.mockDBClient.On("Query", queryGetRoleListCount, testServerID).Return([]map[string]interface{}{
		{"total": int64(10)},
	}, nil)
...
func (suite *RoleStoreTestSuite) TestGetRoleListCount_QueryError() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleListCount, testServerID).Return(nil, queryError)
...
func (suite *RoleStoreTestSuite) TestGetRoleList_Success() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleList, 10, 0, testServerID).Return([]map[string]interface{}{
...
func (suite *RoleStoreTestSuite) TestGetRoleList_QueryError() {
	queryError := errors.New("query error")
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleList, 10, 0, testServerID).Return(nil, queryError)
...
func (suite *RoleStoreTestSuite) TestCreateRole_Success() {
	...
	suite.mockTx.On("Exec", queryCreateRole.Query, mock.Anything, "ou1", "Test Role", "Test Description", testServerID).
		Return(&mockResult{}, nil)
	suite.mockTx.On("Exec", queryCreateRolePermission.Query, mock.Anything, "perm1", testServerID).
		Return(&mockResult{}, nil)
	suite.mockTx.On("Exec", queryCreateRolePermission.Query, mock.Anything, "perm2", testServerID).
		Return(&mockResult{}, nil)
	suite.mockTx.On("Exec", queryCreateRoleAssignment.Query, mock.Anything, AssigneeTypeUser, "user1", testServerID).
		Return(&mockResult{}, nil)
...
func (suite *RoleStoreTestSuite) TestGetRole_Success() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleByID, "role1", testServerID).Return([]map[string]interface{}{
		{"role_id": "role1", "name": "Admin", "description": "Admin role", "ou_id": "ou1"},
	}, nil)
	suite.mockDBClient.On("Query", queryGetRolePermissions, "role1", testServerID).Return([]map[string]interface{}{
		{"permission": "perm1"},
		{"permission": "perm2"},
	}, nil)
...
func (suite *RoleStoreTestSuite) TestGetRole_NotFound() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleByID, "nonexistent", testServerID).Return([]map[string]interface{}{}, nil)
...
func (suite *RoleStoreTestSuite) TestIsRoleExist_Exists() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryCheckRoleExists, "role1", testServerID).Return([]map[string]interface{}{
		{"count": int64(1)},
	}, nil)
...
func (suite *RoleStoreTestSuite) TestIsRoleExist_DoesNotExist() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryCheckRoleExists, "nonexistent", testServerID).Return([]map[string]interface{}{
		{"count": int64(0)},
	}, nil)
...
func (suite *RoleStoreTestSuite) TestGetRoleAssignments_Success() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleAssignments, "role1", 10, 0, testServerID).
...
func (suite *RoleStoreTestSuite) TestGetRoleAssignmentsCount_Success() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryGetRoleAssignmentsCount, "role1", testServerID).Return([]map[string]interface{}{
		{"total": int64(5)},
	}, nil)
...
func (suite *RoleStoreTestSuite) TestUpdateRole_Success() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("BeginTx").Return(suite.mockTx, nil)
	suite.mockTx.On("Exec", queryUpdateRole.Query, "ou1", "Updated Role", "Updated Description", "role1", testServerID).
		Return(&mockResult{rowsAffected: 1}, nil)
	suite.mockTx.On("Exec", queryDeleteRolePermissions.Query, "role1", testServerID).Return(&mockResult{}, nil)
	suite.mockTx.On("Exec", queryCreateRolePermission.Query, "role1", "perm1", testServerID).Return(&mockResult{}, nil)
	suite.mockTx.On("Commit").Return(nil)
...
func (suite *RoleStoreTestSuite) TestUpdateRole_NotFound() {
	...
	suite.mockDBClient.On("BeginTx").Return(suite.mockTx, nil)
	suite.mockTx.On(
		"Exec", queryUpdateRole.Query, "ou1", "Updated Role", "Updated Description", "nonexistent", testServerID,
...
func (suite *RoleStoreTestSuite) TestDeleteRole_Success() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Execute", queryDeleteRole, "role1", testServerID).Return(int64(1), nil)
...
func (suite *RoleStoreTestSuite) TestDeleteRole_ExecuteError() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Execute", queryDeleteRole, "role1", testServerID).Return(int64(0), execError)
...
func (suite *RoleStoreTestSuite) TestAddAssignments_Success() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("BeginTx").Return(suite.mockTx, nil)
	suite.mockTx.On("Exec", queryCreateRoleAssignment.Query, "role1", AssigneeTypeUser, "user1", testServerID).
		Return(&mockResult{}, nil)
	suite.mockTx.On("Commit").Return(nil)
...
func (suite *RoleStoreTestSuite) TestRemoveAssignments_Success() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("BeginTx").Return(suite.mockTx, nil)
	suite.mockTx.On("Exec", queryDeleteRoleAssignmentsByIDs.Query, "role1", AssigneeTypeUser, "user1", testServerID).
		Return(&mockResult{}, nil)
	suite.mockTx.On("Commit").Return(nil)
...
func (suite *RoleStoreTestSuite) TestCheckRoleNameExists_Exists() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryCheckRoleNameExists, "ou1", "Admin", testServerID).
		Return([]map[string]interface{}{
			{"count": int64(1)},
		}, nil)
...
func (suite *RoleStoreTestSuite) TestCheckRoleNameExistsExcludingID_DoesNotExist() {
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", queryCheckRoleNameExistsExcludingID, "ou1", "Admin", "role1", testServerID).
		Return([]map[string]interface{}{
			{"count": int64(0)},
		}, nil)
...
func (suite *RoleStoreTestSuite) TestGetAuthorizedPermissions_Success() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", mock.Anything, testServerID, mock.Anything, mock.Anything, mock.Anything,
		mock.Anything).
		Return(
...
func (suite *RoleStoreTestSuite) TestGetAuthorizedPermissions_NilGroupsHandled() {
	...
	suite.mockDBProvider.On("GetConfigDBClient").Return(suite.mockDBClient, nil)
	suite.mockDBClient.On("Query", mock.Anything, testServerID, mock.Anything, mock.Anything).
